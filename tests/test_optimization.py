...
#                                                 use_adam=False,
#                                                 step_size=0.28)
#     np.testing.assert_almost_equal(output, [2.054, 0.04], decimal=2), 'Stochastic gradient descent with momentum failed'
#
...
#                                                 use_adagrad=True,
#                                                 use_adam=False,
#                                                 step_size=0.28) #0.25 gives array([0.318, 1.249])
...
#                                                 use_adam=True,
#                                                 step_size=0.28)
#     np.testing.assert_almost_equal(output, [2.054, 0.04], decimal=2), 'Stochastic gradient descent with adam failed'
#
...
#     df = pd.read_csv('../data/sgd_example.csv', header=None).T
#     X = df.values
#     output = opt.do_stochastic_gradient_descent(w0, opt.example_loss, X, num_epochs=25, tol=1e-3,
#                                                 use_momentum=False,
#                                                 use_adagrad=False,
#                                                 use_adam=True,
#                                                 step_size=0.28)
